...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.TimestampRequest();
  });
  ...
  describe('TimestampRequest', function() {
    it('should create an instance of TimestampRequest', function() {
      ...
      //var instane = new OriginStampApiDocumentation.TimestampRequest();
      //expect(instance).to.be.a(OriginStampApiDocumentation.TimestampRequest);
    });
