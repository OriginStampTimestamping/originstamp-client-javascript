...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.TimestampResponse();
  });
  ...
  describe('TimestampResponse', function() {
    it('should create an instance of TimestampResponse', function() {
      ...
      //var instane = new OriginStampApiDocumentation.TimestampResponse();
      //expect(instance).to.be.a(OriginStampApiDocumentation.TimestampResponse);
    });
