...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.Notification();
  });
  ...
  describe('Notification', function() {
    it('should create an instance of Notification', function() {
      ...
      //var instane = new OriginStampApiDocumentation.Notification();
      //expect(instance).to.be.a(OriginStampApiDocumentation.Notification);
    });
