...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.DefaultOfDownloadLinkResponse();
  });
  ...
  describe('DefaultOfDownloadLinkResponse', function() {
    it('should create an instance of DefaultOfDownloadLinkResponse', function() {
      // uncomment below and update the code to test DefaultOfDownloadLinkResponse
      //var instane = new OriginStampApiDocumentation.DefaultOfDownloadLinkResponse();
      //expect(instance).to.be.a(OriginStampApiDocumentation.DefaultOfDownloadLinkResponse);
    });
