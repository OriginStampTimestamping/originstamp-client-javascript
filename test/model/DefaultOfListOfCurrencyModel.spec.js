...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.DefaultOfListOfCurrencyModel();
  });
  ...
  describe('DefaultOfListOfCurrencyModel', function() {
    it('should create an instance of DefaultOfListOfCurrencyModel', function() {
      // uncomment below and update the code to test DefaultOfListOfCurrencyModel
      //var instane = new OriginStampApiDocumentation.DefaultOfListOfCurrencyModel();
      //expect(instance).to.be.a(OriginStampApiDocumentation.DefaultOfListOfCurrencyModel);
    });
