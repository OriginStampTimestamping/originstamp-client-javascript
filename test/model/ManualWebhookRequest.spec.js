...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.ManualWebhookRequest();
  });
  ...
  describe('ManualWebhookRequest', function() {
    it('should create an instance of ManualWebhookRequest', function() {
      ...
      //var instane = new OriginStampApiDocumentation.ManualWebhookRequest();
      //expect(instance).to.be.a(OriginStampApiDocumentation.ManualWebhookRequest);
    });
