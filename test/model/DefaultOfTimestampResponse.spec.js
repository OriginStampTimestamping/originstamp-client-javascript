...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.DefaultOfTimestampResponse();
  });
  ...
  describe('DefaultOfTimestampResponse', function() {
    it('should create an instance of DefaultOfTimestampResponse', function() {
      // uncomment below and update the code to test DefaultOfTimestampResponse
      //var instane = new OriginStampApiDocumentation.DefaultOfTimestampResponse();
      //expect(instance).to.be.a(OriginStampApiDocumentation.DefaultOfTimestampResponse);
    });
