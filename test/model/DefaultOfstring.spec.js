...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.DefaultOfstring();
  });
  ...
  describe('DefaultOfstring', function() {
    it('should create an instance of DefaultOfstring', function() {
      // uncomment below and update the code to test DefaultOfstring
      //var instane = new OriginStampApiDocumentation.DefaultOfstring();
      //expect(instance).to.be.a(OriginStampApiDocumentation.DefaultOfstring);
    });
