...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.CurrencyModel();
  });
  ...
  describe('CurrencyModel', function() {
    it('should create an instance of CurrencyModel', function() {
      ...
      //var instane = new OriginStampApiDocumentation.CurrencyModel();
      //expect(instance).to.be.a(OriginStampApiDocumentation.CurrencyModel);
    });
