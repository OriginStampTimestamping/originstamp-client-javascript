...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.DownloadLinkResponse();
  });
  ...
  describe('DownloadLinkResponse', function() {
    it('should create an instance of DownloadLinkResponse', function() {
      ...
      //var instane = new OriginStampApiDocumentation.DownloadLinkResponse();
      //expect(instance).to.be.a(OriginStampApiDocumentation.DownloadLinkResponse);
    });
