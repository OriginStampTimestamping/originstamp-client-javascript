...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.ProofRequest();
  });
  ...
  describe('ProofRequest', function() {
    it('should create an instance of ProofRequest', function() {
      ...
      //var instane = new OriginStampApiDocumentation.ProofRequest();
      //expect(instance).to.be.a(OriginStampApiDocumentation.ProofRequest);
    });
