...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.TimestampData();
  });
  ...
  describe('TimestampData', function() {
    it('should create an instance of TimestampData', function() {
      ...
      //var instane = new OriginStampApiDocumentation.TimestampData();
      //expect(instance).to.be.a(OriginStampApiDocumentation.TimestampData);
    });
