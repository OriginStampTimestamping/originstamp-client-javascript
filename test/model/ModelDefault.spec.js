...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.ModelDefault();
  });
  ...
  describe('ModelDefault', function() {
    it('should create an instance of ModelDefault', function() {
      ...
      //var instane = new OriginStampApiDocumentation.ModelDefault();
      //expect(instance).to.be.a(OriginStampApiDocumentation.ModelDefault);
    });
