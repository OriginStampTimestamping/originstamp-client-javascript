...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.WebhookResponse();
  });
  ...
  describe('WebhookResponse', function() {
    it('should create an instance of WebhookResponse', function() {
      ...
      //var instane = new OriginStampApiDocumentation.WebhookResponse();
      //expect(instance).to.be.a(OriginStampApiDocumentation.WebhookResponse);
    });
