...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.DefaultOfWebhookResponse();
  });
  ...
  describe('DefaultOfWebhookResponse', function() {
    it('should create an instance of DefaultOfWebhookResponse', function() {
      // uncomment below and update the code to test DefaultOfWebhookResponse
      //var instane = new OriginStampApiDocumentation.DefaultOfWebhookResponse();
      //expect(instance).to.be.a(OriginStampApiDocumentation.DefaultOfWebhookResponse);
    });
