...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginStampApiDocumentation.WebhookRequest();
  });
  ...
  describe('WebhookRequest', function() {
    it('should create an instance of WebhookRequest', function() {
      ...
      //var instane = new OriginStampApiDocumentation.WebhookRequest();
      //expect(instance).to.be.a(OriginStampApiDocumentation.WebhookRequest);
    });
