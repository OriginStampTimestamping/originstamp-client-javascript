...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OriginStamp.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.originstamp.com
     */
    this.basePath = 'https://api.originstamp.com'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'API Key Authorization': {type: 'apiKey', 'in': 'header', name: 'Authorization'}
    };
    /**
  ...
  exports.prototype.callApi = function callApi(path, httpMethod, pathParams,
    ...
    headerParams['User-Agent'] = 'OriginStamp Client JS/2.0 ()';
