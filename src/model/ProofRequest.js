...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OriginStampApiDocumentation.ProofRequest = factory(root.OriginStampApiDocumentation.ApiClient);
  }
   ...
   * @class
   * @param currency {Integer} 0: Bitcoin 1: Ethereum 2: AION 100: Südkurier
   ...
   * @param proofType {Integer} Specifies which type of file should be returned. Possible value(s):  0: proof with a seed file (txt) or proof with a merkle tree (xml) 1: proof with a PDF file   Other formats will follow.
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('proof_type')) {
        obj['proof_type'] = ApiClient.convertToType(data['proof_type'], 'Integer');
      }
    }
    return obj;
  }
