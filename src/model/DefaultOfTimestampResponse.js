...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OriginStampApiDocumentation.DefaultOfTimestampResponse = factory(root.OriginStampApiDocumentation.ApiClient, root.OriginStampApiDocumentation.TimestampResponse);
  }
  ...
  /**
   * The DefaultOfTimestampResponse model module.
   * @module model/DefaultOfTimestampResponse
   * @version 3.0
   */

  /**
   * Constructs a new <code>DefaultOfTimestampResponse</code>.
   ...
   * @alias module:model/DefaultOfTimestampResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DefaultOfTimestampResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DefaultOfTimestampResponse} obj Optional instance to populate.
   * @return {module:model/DefaultOfTimestampResponse} The populated <code>DefaultOfTimestampResponse</code> instance.
   */
