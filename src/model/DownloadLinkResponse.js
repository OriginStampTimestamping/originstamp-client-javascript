...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OriginStampApiDocumentation.DownloadLinkResponse = factory(root.OriginStampApiDocumentation.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('file_size_bytes')) {
        obj['file_size_bytes'] = ApiClient.convertToType(data['file_size_bytes'], 'Integer');
      }
    }
    return obj;
  }
  ...
  /**
   * File size in bytes.
   * @member {Integer} file_size_bytes
   */
