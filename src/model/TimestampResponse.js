...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OriginStampApiDocumentation.TimestampResponse = factory(root.OriginStampApiDocumentation.ApiClient, root.OriginStampApiDocumentation.TimestampData);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('date_created')) {
        obj['date_created'] = ApiClient.convertToType(data['date_created'], 'Integer');
      }
