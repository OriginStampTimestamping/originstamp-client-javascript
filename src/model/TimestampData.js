...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OriginStampApiDocumentation.TimestampData = factory(root.OriginStampApiDocumentation.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('submit_status')) {
        obj['submit_status'] = ApiClient.convertToType(data['submit_status'], 'Integer');
      }
